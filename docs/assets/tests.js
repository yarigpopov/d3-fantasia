...
define('d3-fantasia/tests/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/stack-chart.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/stack-chart.js should pass ESLint\n\n5:9 - \'computed\' is defined but never used. (no-unused-vars)\n8:9 - \'run\' is defined but never used. (no-unused-vars)\n112:5 - \'Ember\' is not defined. (no-undef)');
  });
  ...
  (0, _qunit.module)('Integration | Component | stack-chart', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "NenPbv1S",
        "block": "{\"symbols\":[],\"statements\":[[1,[18,\"stack-chart\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('d3-fantasia/tests/tests.lint-test', [], function () {
  'use strict';
